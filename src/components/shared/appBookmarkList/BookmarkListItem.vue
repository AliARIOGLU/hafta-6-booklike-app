    ...
    <div class="bg-white flex flex-col gap-x-3 rounded-md shadow-sm">
        <div class="p-3">
            ...
            <div class="flex items-center justify-center mt-2 gap-x-1">
                ...
                <button @click="bookmarkItem" :class="{ 'bookmark-item-active': alreadyBookmarked }"
...
export default {
    ...
    created() {
        // console.log("likes", this.$store.getters._userLikes)
        // console.log("bookmarks", this.$store.getters._userBookmarks)
    },
    methods: {
        likeItem() {
            this.$appAxios({
